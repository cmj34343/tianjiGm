layui.define(['layer', 'locationX'], function (exports) {
	...
	var tpl1 ='<div class="cur-load0"></div>\n' +
            ...
            // '    &nbsp;&nbsp;经度：<input id="lng" class="layui-input  inline-block" style="width: 190px;" autocomplete="off" />\n' +
            // '    &nbsp;&nbsp;&nbsp;纬度：<input id="lat" class="layui-input  inline-block" style="width: 190px;" autocomplete="off" />\n' +
            // '    <button id="ew-map-select-btn-ok" class="layui-btn icon-btn pull-con" type="button"><i class="layui-icon">&#xe605;</i>确定</button>\n' +
            '</div>\n' +
            '<div class="map-select">\n' +
            '\n' +
            '    <div id="map" style="width: 600px;height: 505px;float: right;"><button id="ew-map-select-btn-ok" class="layui-btn icon-btn pull-con" type="button"><i class="layui-icon">&#xe605;</i>确定</button>\n</div>\n' +
    ...
    var obj = function (config,selfPos = null) {
        ...
        if (this.config.isSelfPos && selfPos != null) {
            this.config.longitude = selfPos.longitude;
            this.config.latitude = selfPos.latitude;
        }
                ...
                if (config["isSelfPos"]) {
                    navigator.geolocation.getCurrentPosition(
                        function (position) {
                            ...
                            var _this = new obj(config,{latitude:latitude,longitude:longitude});
                            _this.openMap();
